 ...
 * 
 * <p> 6/12/2010 S. Lord,
 * Modified to provide access to the audio samples 
 * </p>
 * 
 */
public class MyTranscoder implements Runnable
{
  ...
  /**
   * Stop the {@link MyTranscoder} loop if it's running
   * on a separate thread.
   * <p>
   * It does this by sending a
   * {@link Red5Message} for the end of stream 
   * 
   * to the {@link MyTranscoder} and allowing it to
   * exit gracefully.
   * </p>
   * @see #run()
   */
